...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @return
     */
    public static String getRandomArray(int num) {
        Random random = new Random();
        String result = "";
        for (int i = 0; i < num; i++) {
     ...
     */
    public static Map<String, String> pararmToMap(Map<String, String[]> requestParams) {
        // 将参数放入map
     ...
     * @return Map<String, String>
     */
    public static Map<String, Object> xxeProtectXmlToMap(String xml) {
        ...
        try {
            ...
            org.w3c.dom.Document document = safebuilder.parse(new InputSource(new StringReader(xml)));
